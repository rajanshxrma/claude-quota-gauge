...
estimation, no browser scraping, no stored credentials. This script prints
the statusline text and caches the numbers to disk so the SessionStart hook
and the background watcher can read the latest known real values without
needing stdin themselves.
"""
import sys, os, json
